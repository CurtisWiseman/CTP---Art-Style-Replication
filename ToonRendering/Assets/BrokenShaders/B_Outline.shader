...
Shader "B_Outline"
{
	Properties
	{
		...
		_Width("Width",Range(0.0, 10.0)) = 0.0
		_ColourRed("ColourRed",Range(0.0, 1.0)) = 0.0
		_ColourGreen("ColourGreen",Range(0.0, 1.0)) = 0.0
		_ColourBlue("ColourBlue",Range(0.0, 1.0)) = 0.0
	}
		SubShader
	{
		Pass
